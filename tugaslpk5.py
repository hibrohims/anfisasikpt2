...
with tab3:
        ...
        with st.expander("Percobaan 1, Hubungan Kerapatan dan Kepekatan Larutan (Kerapatan Air)"):
                ...
                Tombol0 = st.button ('Hitung Kerapatan Air')
                if Tombol0: 
        ...
        with st.expander('Percobaan 1, Hubungan Kerapatan dan Kepekatan Larutan (Kerapatan Deret Standar)'):
                ...
                Tombol00 = st.button ('Hitung Kerapatan Larutan Garam')
                if Tombol00: 
        ...
        with st.expander("Percobaan 2, Penetapan Kerapatan Curah, Absolut, dan Relatif"):
            ...
            Tombol1 = st.button ('Hitung Percobaan 2')
            if Tombol1 :
                #Kalkulator Curah
        ...
        with st.expander ("Percobaan 3, Penentuan Kekentalan Metode Laju Alir Ostwald"):
            #Massa Air Suling
            ...
            Tombol2 = st.button ('Hitung Percobaan 3')
            if Tombol2 :
                #Kerapatan Aquadest
        ...
        with st.expander ("Percobaan 4, Penentuan Kekentalan Metode Silinder Berputar Brookfield"):
            ...
            Tombol4 = st.button ('Hitung Percobaan 4')
            if Tombol4 :
        ...
        with st.expander("Percobaan 5, Penentuan Kekentalan Metode Laju Alir Engler"):
            #Massa Air Aquadest
            ...
            Tombol5 = st.button ('Hitung Percobaan 5')
            if Tombol5 :
                #Kerapatan Aquadest
        ...
        with st.expander("Percobaan 6, Penetapan Titik Leleh"):
            ...
            Tombol6 = st.button ('Hitung Percobaan 6')
            if Tombol6 :
                Rentang_Leleh = FMelt-SMelt
                st.success(f'Rentang Melelehnya ialah {Rentang_Leleh} °C')

        with st.expander ("Percobaan 7, Penetapan Koefisien Muai Air dan Alkohol"):
        ...
        with st.expander("Percobaan 8, Penetapan Kuat Tekan"):
            ...
            Tombol8 = st.button ('Hitung Percobaan 8')
            if Tombol8 :
